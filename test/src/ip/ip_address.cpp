...
TEST(IPAddressTest, IPv4)
{
    ...
    EXPECT_THROW(chen::ip::address_v4::toInteger("127.0.0.1/99"), chen::ip::error_subnet);
}
...
TEST(IPAddressTest, IPv6)
{
    ...
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("2001:db8:c000:221::").embedded(32));
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("2001:db8:1c0:2:21::").embedded(40));
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("2001:db8:122:c000:2:2100::").embedded(48));
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("2001:db8:122:3c0:0:221::").embedded(56));
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("2001:db8:122:344:c0:2:2100::").embedded(64));
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("2001:db8:122:344::192.0.2.33").embedded(96));
    EXPECT_EQ(chen::ip::address_v4("192.0.2.33"), chen::ip::address_v6("64:ff9b::192.0.2.33").embedded(96));
    ...
    EXPECT_THROW(chen::ip::address_v6::toBytes("::1/200"), chen::ip::error_subnet);
}