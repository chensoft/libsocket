...
TEST(IPAddressTest, Base)
{
    ...
    EXPECT_NE(nullptr, std::dynamic_pointer_cast<chen::ip::address_v4>(ptr));
    EXPECT_EQ(nullptr, std::dynamic_pointer_cast<chen::ip::address_v6>(ptr));
    EXPECT_EQ("127.0.0.1/8", ptr->str(true));
    EXPECT_EQ(ptr.get(), ptr->v4());
    EXPECT_EQ(nullptr, ptr->v6());
    ...
    EXPECT_NE(nullptr, std::dynamic_pointer_cast<chen::ip::address_v6>(ptr));
    EXPECT_EQ(nullptr, std::dynamic_pointer_cast<chen::ip::address_v4>(ptr));
    EXPECT_EQ("2404:6800:4004:817::200e/64", ptr->str(true));
    EXPECT_EQ(nullptr, ptr->v4());
    EXPECT_EQ(ptr.get(), ptr->v6());
...
TEST(IPAddressTest, IPv4)
{
    ...
    EXPECT_THROW(chen::ip::address_v4("127.0.0.1", 33), chen::ip::error_address);
    EXPECT_THROW(chen::ip::address_v4(0x7F000001, 33), chen::ip::error_address);
    ...
    EXPECT_EQ("127.0.0.1", chen::ip::address_v4("127.0.0.1").str());
    EXPECT_EQ("127.0.0.1/8", chen::ip::address_v4("127.0.0.1/8").str(true));
    EXPECT_EQ("127.0.0.1/8", chen::ip::address_v4(0x7F000001, 8).str(true));
    EXPECT_EQ("192.168.1.1/30", chen::ip::address_v4("192.168.1.1", 30).str(true));
    ...
    EXPECT_EQ("127.0.0.0/8", chen::ip::address_v4("127.0.0.1/8").network().str(true));
    EXPECT_EQ("127.0.0.1/8", chen::ip::address_v4("127.0.0.1/8").minhost().str(true));
    EXPECT_EQ("127.255.255.254/8", chen::ip::address_v4("127.0.0.1/8").maxhost().str(true));
    EXPECT_EQ("127.255.255.255/8", chen::ip::address_v4("127.0.0.1/8").broadcast().str(true));
    EXPECT_EQ(16777214, chen::ip::address_v4("127.0.0.1/8").hosts());

    // special
    EXPECT_TRUE(chen::ip::address_v4("0.0.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("127.0.0.1").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("169.254.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("192.0.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("192.0.2.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("192.88.99.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("198.51.100.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("203.0.113.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("224.0.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("240.0.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("10.0.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("100.64.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("172.16.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("192.168.0.0").isReserved());
    EXPECT_TRUE(chen::ip::address_v4("198.18.0.0").isReserved());

    EXPECT_TRUE(chen::ip::address_v4("10.0.0.0").isPrivate());
    EXPECT_TRUE(chen::ip::address_v4("100.64.0.0").isPrivate());
    EXPECT_TRUE(chen::ip::address_v4("172.16.0.0").isPrivate());
    EXPECT_TRUE(chen::ip::address_v4("192.168.0.0").isPrivate());
    EXPECT_TRUE(chen::ip::address_v4("198.18.0.0").isPrivate());

    EXPECT_TRUE(chen::ip::address_v4("127.0.0.1").isLoopback());
    EXPECT_FALSE(chen::ip::address_v4("192.168.0.1").isLoopback());

    EXPECT_TRUE(chen::ip::address_v4("169.254.0.0").isLinkLocal());

    EXPECT_TRUE(chen::ip::address_v4("224.0.0.115").isMulticast());
    EXPECT_FALSE(chen::ip::address_v4("10.0.0.1").isMulticast());
...
TEST(IPAddressTest, IPv6)
{
    ...
    EXPECT_EQ(chen::ip::address_v6("2404:6800:4004:817::200e"), chen::ip::address_v6(c_bytes));
    EXPECT_EQ(chen::ip::address_v6("2404:6800:4004:817::200e/64"), chen::ip::address_v6(c_bytes, 64));
    EXPECT_EQ(chen::ip::address_v6("2404:6800:4004:817::200e/64"), chen::ip::address_v6(c_bytes, "ffff:ffff:ffff:ffff::"));
    ...
    EXPECT_EQ("2404:6800:4004::/46", chen::ip::address_v6("2404:6800:4004:817::200e/46").network().str(true));
    EXPECT_EQ("2404:6800:4004:817::200e", chen::ip::address_v6("2404:6800:4004:817::200e/128").network().str());

    EXPECT_EQ("2404:6800:4004::/46", chen::ip::address_v6("2404:6800:4004:817::200e/46").minhost().str(true));
    EXPECT_EQ("2404:6800:4007:ffff:ffff:ffff:ffff:ffff/46", chen::ip::address_v6("2404:6800:4004:817::200e/46").maxhost().str(true));

    EXPECT_EQ("2404:6800:4004:817::200e", chen::ip::address_v6("2404:6800:4004:817::200e/128").minhost().str());
    EXPECT_EQ("2404:6800:4004:817::200e", chen::ip::address_v6("2404:6800:4004:817::200e/128").maxhost().str());
    ...
    EXPECT_TRUE(chen::ip::address_v6("64:ff9b::73b6:405e").isIPv4EmbeddedWellKnown());
    EXPECT_FALSE(chen::ip::address_v6("2001:db8:122:344::").isIPv4EmbeddedWellKnown());
