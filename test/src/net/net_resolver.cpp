...
TEST(NetResolverTest, IPv4)
{
    ...
    EXPECT_EQ("0.0.0.0:80", inet_resolver::resolve(":80", address::Type::IPv4)[0].str());
    EXPECT_EQ("127.0.0.1:0", inet_resolver::resolve("127.0.0.1", address::Type::IPv4)[0].str());
    EXPECT_EQ("127.0.0.1:80", inet_resolver::resolve("127.0.0.1:80", address::Type::IPv4)[0].str());
    EXPECT_EQ("127.0.0.1:80", inet_resolver::resolve("127.0.0.1:http", address::Type::IPv4)[0].str());
    ...
    EXPECT_EQ("0.0.0.0:80", inet_resolver::resolve("", 80, address::Type::IPv4)[0].str());
    EXPECT_EQ("127.0.0.1:0", inet_resolver::resolve("127.0.0.1", 0, address::Type::IPv4)[0].str());
    EXPECT_EQ("127.0.0.1:80", inet_resolver::resolve("127.0.0.1", 80, address::Type::IPv4)[0].str());
}
...
TEST(NetResolverTest, IPv6)
{
    ...
    EXPECT_EQ("[::]:80", inet_resolver::resolve("[::]:80", address::Type::IPv6)[0].str());
    EXPECT_EQ("[fe80::1]:0", inet_resolver::resolve("[fe80::1]", address::Type::IPv6)[0].str());
    EXPECT_EQ("[fe80::1]:80", inet_resolver::resolve("[fe80::1]:80", address::Type::IPv6)[0].str());
    EXPECT_EQ("[fe80::1]:80", inet_resolver::resolve("[fe80::1]:http", address::Type::IPv6)[0].str());
    ...
    EXPECT_EQ("[::]:80", inet_resolver::resolve("::", 80, address::Type::IPv6)[0].str());
    EXPECT_EQ("[fe80::1]:0", inet_resolver::resolve("fe80::1", 0, address::Type::IPv6)[0].str());
    EXPECT_EQ("[fe80::1]:80", inet_resolver::resolve("fe80::1", 80, address::Type::IPv6)[0].str());
}
