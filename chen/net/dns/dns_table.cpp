...
namespace
{
    ...
    std::map<chen::dns::RRType, table::rr_build_type> g_rr_build = {
            ...
            {chen::dns::RRType::A6, [] () -> rr_pointer { return rr_pointer(new chen::dns::A6); }},
            {chen::dns::RRType::DNAME, [] () -> rr_pointer { return rr_pointer(new chen::dns::DNAME); }},
            {chen::dns::RRType::SINK, [] () -> rr_pointer { return rr_pointer(new chen::dns::SINK); }},
            ...
            {chen::dns::RRType::SMIMEA, [] () -> rr_pointer { return rr_pointer(new chen::dns::SMIMEA); }},
            ...
            {chen::dns::RRType::CSYNC, [] () -> rr_pointer { return rr_pointer(new chen::dns::CSYNC); }},
    ...
    std::map<std::string, chen::dns::RRType> g_rr_text_type;
    ...
    std::map<std::string, chen::dns::RRClass> g_rr_text_class;
    ...
    std::map<std::string, chen::dns::QR> g_rr_text_qr;
    ...
    std::map<std::string, chen::dns::OPCODE> g_rr_text_opcode;
...
//        {chen::dns::RCODE::BadSig, "BADSIG"},
    ...
    std::map<std::string, chen::dns::RCODE> g_rr_text_rcode;
